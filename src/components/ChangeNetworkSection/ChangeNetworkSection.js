...
export default function ChangeNetworkSection ({
                                  currentNetwork,
                                                  requiredChainId,
        ...
        <Container>
            <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
                ...
                <TextColumn textOnLeft={textOnLeft}>
                    <TextContent>
                        <Subheading>We natively support {currentNetwork.name}. But your infra is pointing somewhere else.</Subheading>
                        <Heading>Network Change Required.</Heading>
                        <Description>
                            In order work with this specific feature, you'll have to change your network.
                        </Description>
